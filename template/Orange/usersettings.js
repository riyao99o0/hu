...
(function () {
	...
	model.publish(rh.consts('KEY_SEARCH_HIGHLIGHT_COLOR'), "")
	model.publish(rh.consts('KEY_SEARCH_BG_COLOR'), "")
	model.publish(rh.consts('DATA_TOC_IMG_DATA_SET'),[]);
	...
	model.publish(rh.consts('SHOW_PDF_DOWNLOAD'), "English/An_Alien_Hand/Chapter_1_-_The_Tiny_Teacher.htm");
